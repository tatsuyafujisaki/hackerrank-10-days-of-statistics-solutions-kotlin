...
fun main() {
    ...
    val grade80orLessProbability = cdf(mean, standardDeviation, 80.0)
    val grade60orLessProbability = cdf(mean, standardDeviation, 60.0)
    println("%.2f".format(100.0 * (1.0 - grade80orLessProbability)))
    println("%.2f".format(100.0 * (1.0 - grade60orLessProbability)))
    println("%.2f".format(100.0 * grade60orLessProbability))
}
